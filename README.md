...
* Edit local README.md file and update all links (just replace all occurrences of `'Atrashevsky-Pavel'` with your account name).
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/Atrashevsky-Pavel/js-assignments/builds).
